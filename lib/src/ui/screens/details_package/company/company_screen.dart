...
class _CompanyScreenState extends State<CompanyScreen> {
  ...
  void initState() {
    ...
    _companyBloc.add(FetchFeaturedProductCompany(id: _companyId.toString()));
    _companyBloc.add(FetchCompanyProducts(companyId: _companyId.toString()));
            ...
            RefreshIndicator(
                onRefresh: () async {
                  setState(() {
                    ...
                    _companyBloc.add(
                        FetchFeaturedProductCompany(id: _companyId.toString()));
                    _companyBloc.add(
                        FetchCompanyProducts(companyId: _companyId.toString()));
                  });
                },
                    ...
                    onPressed: () async {
                      if (_user == null) {
                        ...
                        if (company!.deviceToken != null) {
                          ...
                          await canLaunch(
                                  "https://wa.me/+2${company!.leftDataOfCompanies!.firstMobile != null && company!.leftDataOfCompanies!.firstMobile != '' ? company!.leftDataOfCompanies!.firstMobile : company!.firstPhone}")
                              ? launch(
                                  "https://wa.me/+2${company!.leftDataOfCompanies!.firstMobile != null && company!.leftDataOfCompanies!.firstMobile != '' ? company!.leftDataOfCompanies!.firstMobile : company!.firstPhone}")
                              : print("cannot launch");
                        }
                  ...
                  child: IconButton(
                    onPressed: () async {
                      if (_user == null) {
                        ...
                        if (company!.deviceToken != null) {
                          await canLaunch(
                                  "tel:${company!.leftDataOfCompanies!.firstMobile != null && company!.leftDataOfCompanies!.firstMobile != '' ? company!.leftDataOfCompanies!.firstMobile : company!.firstPhone}")
                              ? launch(
                                  "tel:${company!.leftDataOfCompanies!.firstMobile != null && company!.leftDataOfCompanies!.firstMobile != '' ? company!.leftDataOfCompanies!.firstMobile : company!.firstPhone}")
                              : print("cannot launch");
                        }
