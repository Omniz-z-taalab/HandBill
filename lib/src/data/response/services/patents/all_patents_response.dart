...
class AllPatentsResponse {
  List<PatentedModel>? _data;
  Links? _links;
  Meta? _meta;
  bool? _status;
  String? _message;

  List<PatentedModel>? get data => _data;
  ...
  AllPatentsResponse.fromJson(dynamic json) {
    if (json["data"] != null) {
      _data = [];
      json["data"].forEach((v) {
        _data?.add(PatentedModel.fromJson(v));
      });
    }
